...
class LoginAccountModal extends Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
            username: '',
    ...
    render() {
        return (
            <>
                ...
                <ModalContent>
                    <ModalHeaderDetails>Login to your NeoNetwork Account</ModalHeaderDetails>
                    <Form>
                        <UsernameInput
                        ...
                        <PasswordInput
                            ...
                            required
                        />
                        <SubmitButton full onClick={this.handleSubmit}>Login</SubmitButton>
                    </Form>
                </ModalContent>
            </>
        )
